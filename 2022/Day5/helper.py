...
def part1(input):
	crate_rows,	parsed_procedures = parser_help(input)
	final_crate_rows = move_crates(crate_rows, parsed_procedures, False)
	result = find_top_crate(final_crate_rows)
	return result

def part2(input):
	crate_rows,	parsed_procedures = parser_help(input)
	final_crate_rows = move_crates(crate_rows, parsed_procedures, True)
	result = find_top_crate(final_crate_rows)
	return result
