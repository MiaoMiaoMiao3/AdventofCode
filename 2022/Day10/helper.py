...
def part2(input):
	register_tracker = setters.set_register_tracker()
	result = find_signal_strength_part2(input, register_tracker)
	return result

def find_signal_strength_part2(input, register_tracker):
	signal_strength = 1
...
def find_signal_strength_part2(input, register_tracker):
	...
	for cpu_instruction in input:
		instruction = cpu_instruction.split(" ")
		register_tracker, signal_strength, target_cycle_count = update.update_register_part2( \
			instruction, register_tracker, signal_strength, target_cycle_count)
	return signal_strength